...
export const Header = () => {
    ...
    useEffect(() => {
        ...
        if (token.estado_token === "ACTIVE") {
            setLogin(true)
            setNomUser(`${token.user.firstNameUser} ${token.user.lastNameUser}`)
        }else {
            setLogin(false);
        }
            ...
            <div className='contain-bar-and-buttons'>
                ...
                <div className='contain-buttons-sesion'>
                    {!login ? (
                        ...
                        <a className='content-elements-perfil' href='/home/perfil'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-person-circle icon-perfile" viewBox="0 0 16 16">

...
import '../../../assets/styles/updatePassd.css'
import axios from 'axios';


export const UpdatePassd = () => {

    const [emailSubmit, setEmailSubmit] = useState("");

    const handleSubmit = () => {

        axios.post(`http://localhost:8080/api/v1/passd/auth/solicitar-password`, {
            email: emailSubmit
        }).then(response => {
    ...
    return (
        <section className="card-passd">
            <div className="popup">
                <form className="form_index" onSubmit={handleSubmit}>
                    <div className="icon">
                    ...
                    <div className="note">
                        <label className="title">🔒 Restablecer contraseña</label>
                        <span className="subtitle">Ingresa tu correo electrónico y te enviaremos un enlace para que puedas crear una nueva contraseña de forma segura.</span>
                    </div>
                    <input
                    ...
                    />
                    <button className="submit">ENVIAR ENLACE</button>
                    <a href="/home/login">Volver</a>
